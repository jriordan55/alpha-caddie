...
function sgFields(row) {
  ...
  return {
    ...
    sg_t2g: f("sg_t2g"),
    sg_total: f("sg_total"),
    sg_50_100_fw: f("sg_50_100_fw"),
    sg_100_150_fw: f("sg_100_150_fw"),
    sg_150_200_fw: f("sg_150_200_fw"),
    sg_over_200_fw: f("sg_over_200_fw"),
    sg_under_150_rgh: f("sg_under_150_rgh"),
    sg_over_150_rgh: f("sg_over_150_rgh"),
    sg_app_dist_total: f("sg_app_dist_total"),
    n_50_100_fw: f("n_50_100_fw"),
    n_100_150_fw: f("n_100_150_fw"),
    n_150_200_fw: f("n_150_200_fw"),
    n_over_200_fw: f("n_over_200_fw"),
    n_under_150_rgh: f("n_under_150_rgh"),
    n_over_150_rgh: f("n_over_150_rgh"),
    n_app_dist: f("n_app_dist"),
    sg_putt_0_5ft: f("sg_putt_0_5ft"),
    sg_putt_5_10ft: f("sg_putt_5_10ft"),
    sg_putt_10_15ft: f("sg_putt_10_15ft"),
    sg_putt_15_25ft: f("sg_putt_15_25ft"),
    sg_putt_25plus_ft: f("sg_putt_25plus_ft"),
    sg_putt_dist_total: f("sg_putt_dist_total"),
    n_putt_0_5ft: f("n_putt_0_5ft"),
    n_putt_5_10ft: f("n_putt_5_10ft"),
    n_putt_10_15ft: f("n_putt_10_15ft"),
    n_putt_15_25ft: f("n_putt_15_25ft"),
    n_putt_25plus_ft: f("n_putt_25plus_ft"),
    n_putt_dist: f("n_putt_dist"),
  };
}
